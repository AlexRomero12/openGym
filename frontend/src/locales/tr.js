...
export default {
  ...
  'Minimum weight': 'Minimum ağırlık',
  'The empty machine — leave at 0 to start warm-ups at a third of your work weight.': 'Boş makine — ısınma setlerine çalışma ağırlığının üçte birinden başlamak için 0 bırak.',
  'Bar ({0})': 'Bar ({0})',
  'Bar {0}': 'Bar {0}',
