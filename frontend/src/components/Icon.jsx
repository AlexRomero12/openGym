...
const P = {
  ...
  // A tape/ruler with tick marks — the body-measurements card, next to `scale` for weight.
  ruler: <><rect x="2.6" y="8.6" width="18.8" height="6.8" rx="1.8" /><path d="M6.4 8.6v2.4M9.4 8.6v3.4M12.4 8.6v2.4M15.4 8.6v3.4M18.4 8.6v2.4" /></>,
