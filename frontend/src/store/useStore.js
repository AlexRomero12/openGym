...
export const DEF = {
  ...
  // Body measurements (waist, chest, arm, thigh), one entry per day in the profile's length unit
  // — see lib/measurements.js. A sibling of bodyweight: same sync, backup and merge rules.
  measurements: [],
